...
%--------------Put responsible grandparents graph here----------------
...
The following are examples of the result we had from the model:
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{OHS27.png}
    \caption{Possible Spread of Synthetic Opioids in Ohio in Year 2027}
    \label{OHS27}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{OHH27.png}
    \caption{Possible Spread of Heroin in Ohio in Year 2027}
    \label{OHH27}
\end{figure}
