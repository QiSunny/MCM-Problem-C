...
\begin{itemize}
    \item As we use CA algorithm to calculate the number of drug reports in the past and to predict the contingent number of drug reports in the future, our calculating time spent on the program is negligible, since the algorithm we use is pretty fast.
    \item As we tested our model with the data given, we know that the algorithm we use and the model we build are very reliable.
\end{itemize}
...
\bibitem{1} 2019 MCM/ICM Problems, 2019, www.comap-math.com/mcm/. \\

\bibitem{2} Lei, Yu, et al. 2007, www.docin.com/p-1308656886.html?docfrom=rrela. \\

\bibitem{3} Mushayabasa, Steady, et al. "Modeling Illicit Drug Use Dynamics and Its Optimal Control Analysis." US National Library of Medicine 
National Institutes of Health, 2015, https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4707024/ \\

\bibitem{4} Sirakoulis, G. Ch., et al. "A cellular automaton model for the effects of population movement and vaccination on epidemic propagation." Elsevier, 2000. http://www.dpi.inpe.br/gilberto/cursos/st-society-2013/Sirakoulis2000.pdf \\
