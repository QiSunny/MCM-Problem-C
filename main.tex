...
From the graph we can tell that, among the three influential factors, the responsibility of grandparents takes a important role in reducing the rate of using drugs. In comparison to the graph of that factor, thethe other two factors, "never married" and "high school degree" 
